...
//   const total = mesa.productos?.reduce((acc, p) => acc + p.precio * p.cantidad, 0) ?? 0;

//   return (
//   <Dialog open={open} onOpenChange={onClose}>
//     <DialogContent>
//       {!mesa ? (
//         <p className="text-red-500">No se encontró información de la mesa.</p>
//       ) : (
//         <>
//           <DialogHeader>
...
//                 Total: ${mesa.productos?.reduce((acc, p) => acc + p.precio * p.cantidad, 0) ?? 0}
//               </p>
//             </div>
//           ) : (
//             <div className="space-y-2">
